...
@section('content')
    ...
    <script>
        ...
        function checkDate()
        {
            ...
            //if it's a previous week
            // if week is in the next year
            if(w < week && year == y) {
                alert("Sorry, you can't book for past weeks");
                location.reload();
            }
            else{
                ...
                if(w==52||w==1){
                    ...
                    location.reload();
                    //window.location = "/meetings/choose/{{$idStud}}";
                }
                ...
                // over the maximum
                    ...
                    document.getElementById('demo1-upload').action = "/meetings/book/{{$idStud}}";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        <ul id="myTabedu1" class="tab-review-design">
                            <li class="active"><a href="#description">Choose a teacher</a></li>
                                        ...
                                        <div class="review-content-section">
                                            <div id="dropzone1" class="pro-ad">
                                                <form name="form"
                                                      ...
                                                      id="demo1-upload" enctype="multipart/form-data" onsubmit="checkDate()">
                                                    @csrf
                                                    <div class="row">
