...
{{--                    </li>--}}
                    <li @if(\Request::path()=='teacher/list' || \Request::path()=='teacher/add' || \Request::path()=='teacher/edit') class="active" @endif>
                        <a class="has-arrow" href="/teacher/list" aria-expanded="false"><span
                                class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Teachers</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Teachers" href="/teacher/list"><span class="mini-sub-pro">All Teachers</span></a>
                            </li>
                            <li><a title="Add Teacher" href="/teacher/add"><span class="mini-sub-pro">Add Teacher</span></a>
                            </li>
...
{{--                    </li>--}}
                    <li @if(\Request::path()=='user/list' || \Request::path()=='user/add' || \Request::path()=='user/edit') class="active" @endif>
                        <a class="has-arrow" href="/user/list" aria-expanded="false"><span
                                class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Users</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Departments List" href="/user/list"><span class="mini-sub-pro">All Users</span></a>
                            </li>
                            <li><a title="Add Departments" href="/user/add"><span class="mini-sub-pro">Add User</span></a>
                            </li>
                        </ul>
                    </li>
{{--                    <li>--}}
